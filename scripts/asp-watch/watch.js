...
// カテゴリごとの「悩み・共感」導入と「こんな方におすすめ」を用意し、
// 読まれやすい記事構成(共感→提案→行動喚起)のベースにする
const CATEGORY_HOOKS = {
  '総合通販': { pain: '欲しいものは決まっているのに、どこで買うのが一番お得か迷っていませんか？', points: ['普段の買い物をもっとお得にしたい方', '欲しい商品をまとめて探したい方'] },
  '健康': { pain: '最近なんとなく体調がすぐれない日が続いていませんか？', points: ['健康管理を見直したい方', '毎日のコンディションをサポートしたい方'] },
  '美容': { pain: '鏡を見るたびに、肌や見た目の変化が気になっていませんか？', points: ['自分磨きを始めたい方', '新しいケア方法を試したい方'] },
  'グルメ・食品': { pain: '毎日の食事、もっと美味しく・便利にできたらと思いませんか？', points: ['自宅での食事を充実させたい方', '手軽に良いものを取り寄せたい方'] },
  'ファッション': { pain: '「そろそろ新しい一着が欲しいな」と思うことはありませんか？', points: ['トレンドを取り入れたい方', 'お気に入りの一着を探している方'] },
  '旅行': { pain: '「どこかへ出かけたいけど、何から決めればいいか分からない」ことはありませんか？', points: ['次の旅行先を探している方', 'お得に旅行を計画したい方'] },
  '金融・投資・保険': { pain: 'このままの家計や備えで大丈夫か、ふと不安になることはありませんか？', points: ['家計や資産を見直したい方', '将来への備えを考えたい方'] },
  '不動産・引越': { pain: '住まいのことで「そろそろ動くべきかな」と考えていませんか？', points: ['住み替えや引越しを検討している方', '物件情報を比較したい方'] },
  '仕事情報': { pain: '今の職場、このまま働き続けていいのかなと感じることはありませんか？', points: ['キャリアの選択肢を増やしたい方', '今より良い条件で働きたい方'] },
  '学び・資格': { pain: '「何か新しいことを学びたい」と思いながら、後回しにしていませんか？', points: ['スキルアップを目指したい方', '新しい資格に挑戦したい方'] },
  '暮らし': { pain: '日々の暮らしの中で、ちょっとした不便を感じていませんか？', points: ['暮らしをもっと快適にしたい方', '便利なサービスを探している方'] },
  'Webサービス': { pain: 'もっと便利なツールやサービスがあるはずなのに、と感じていませんか？', points: ['作業や手続きを効率化したい方', '新しいサービスを試したい方'] },
  'インターネット接続': { pain: '今のネット環境、料金や速度に不満はありませんか？', points: ['通信費を見直したい方', 'より快適な通信環境を探している方'] },
  'エンタメ': { pain: '「何か楽しいことがしたい」と思うことはありませんか？', points: ['新しい娯楽を探している方', '普段の生活に楽しみを増やしたい方'] },
  'ギフト': { pain: '大切な人への贈り物、何にするか迷っていませんか？', points: ['特別な人へのギフトを探している方', '記念日の贈り物を考えている方'] },
  'スポーツ・趣味': { pain: '「何か始めたいけど、きっかけがない」と感じていませんか？', points: ['新しい趣味やスポーツを始めたい方', '今の趣味をもっと充実させたい方'] },
  '結婚・恋愛': { pain: '人生の大切な選択について、一人で悩んでいませんか？', points: ['将来について考え始めた方', '新しい出会いを探している方'] },
};

function buildNoteDraft(item) {
  const hook = CATEGORY_HOOKS[item.category] || {
    pain: '「もっと良い方法があるかもしれない」と感じることはありませんか？',
